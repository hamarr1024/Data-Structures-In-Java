...
public final class BinaryTrees {
	...
	public static BinaryTreeInfo wrap(BinarySearchTree<?> bst) {
		return new BinaryTreeInfo() {
			...
			public Object left(Object node) {
				return ((BinarySearchTree.Node) node).left();
			}

			@Override
			public Object right(Object node) {
				return ((BinarySearchTree.Node) node).right();
			}
